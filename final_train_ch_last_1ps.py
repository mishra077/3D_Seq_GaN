...
from capnet import Capsule
#from d3d2dNET import MSFgNet
...
dataset = {
            'badWeather':['wetSnow'], #, 'wetSnow', 'skating'],
            'baseline':['highway', 'pedestrians', 'PETS2006'],                                                          #, 'office'
            'cameraJitter':['badminton', 'sidewalk', 'traffic'],                                                          #, 'boulevard'
            'dynamicBackground':['boats', 'fall', 'fountain01', 'fountain02', 'overpass'], #'canoe',
...
path = r'C:\Users\santo\OneDrive\Desktop\soumendu_work\data\model_save\ch_last\3d_cap\*h5' 
...
if (files):
    ...
    model = Capsule(input_shape, input_shape2)
...
checkpoint = ModelCheckpoint(r'C:\Users\santo\OneDrive\Desktop\soumendu_work\data\model_save\ch_last\3d_cap\dsfmdl.{epoch:03d}.h5', monitor='loss', mode='min')
